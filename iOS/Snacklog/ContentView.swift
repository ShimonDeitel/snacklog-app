...
struct ContentView: View {
    ...
    @State private var editingEntry: SnacklogEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Roadtrip Snack Log")
            .toolbar {
...
struct EntryEditorView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(entry == nil ? "Add Stop" : "Edit Stop")
            .toolbar {
