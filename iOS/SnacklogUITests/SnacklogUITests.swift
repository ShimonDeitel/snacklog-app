...
final class SnacklogUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["purchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Roadtrip Snack Log Pro"].waitForExistence(timeout: 3))
    }
